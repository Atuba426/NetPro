...
import postReducer, { resetPostId } from "@/config/redux/reducers/postReducer";
export default function Dashboard() {
            ...
            <div className={styles.wrapper}>
              <div className={styles.createPostContainer}>
                ...
                {postContent.length > 0 && (
                  <div onClick={handleUpload} className={styles.uplaodButton}>
                    Post
                  </div>
                )}
              </div>
                          ...
                          <div className={styles.optionsContainer}>
                            ...
                            <div
                              onClick={() => {
                                ...
                                const Url = encodeURIComponent("ayesha.com");
  ...
  >
    <div
      ...
      onClick={(e) => e.stopPropagation()} // ✅ Move stopPropagation here
    >
                  ...
                  <div className={styles.comment_heading}>
                    ...
                    {Comment.userId._id === authState.user.userId._id && (
                      <div
                        onClick={async () => {
                          await dispatch(
                            deleteOneComment({ comment_id: Comment._id })
                          );
                          await dispatch(
